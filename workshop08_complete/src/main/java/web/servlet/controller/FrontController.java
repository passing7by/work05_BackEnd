...
public class FrontController extends HttpServlet {
	...
	protected @ResponseBody void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	@RequestMapping(value = "/*", produces = "application/text; charset=UTF-8")
	private @ResponseBody void showDesc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
